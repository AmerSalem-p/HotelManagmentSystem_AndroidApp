...
public class addNewCustommer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_new_custommer);
    ...
    public void addnewCustomerOnClick(View view) {
        String resturl = "http://10.0.2.2/hotel-system/addNewCustomer.php";
    ...
    public class SendPostRequest extends AsyncTask<String, Void, String>{
        ...
        protected void onPostExecute(String result){
            Toast.makeText(addNewCustommer.this, result, Toast.LENGTH_SHORT).show();
        }
    }
